...
public class JobsSearch {
	...
	public void openJobDetails() {
		wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//li[@class='post-1956 job_listing type-job_listing status-publish hentry job-type-full-time']//h3[contains(text(),'Tester')]")));
		driver.findElement(By.xpath("//li[@class='post-1956 job_listing type-job_listing status-publish hentry job-type-full-time']//h3[contains(text(),'Tester')]")).click();
	}
